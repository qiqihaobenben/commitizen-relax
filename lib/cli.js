...
var spinner = (0, ora_1.default)({ text: chalk_1.default.black.bgWhite("cz-relax init... \n"), spinner: "dots" });
spinner.start();
...
commander_1.program
    ...
    .addOption(new commander_1.Option("-l, --language <type>", "need to set a profile type").choices(["zh", "en"]).default("zh"))
...
var adapterNamName = initOptions.adapter;
if (command === "init") {
    try {
        console.log(chalk_1.default.cyan("1.) commitizen init..."));
        (0, commitizen_1.default)(process.cwd(), adapterNamName, initOptions);
